window.nova_plugins.push({
   ...
   options: {
      ...
      time_remaining_format: {
         ...
         // value: '',
         required: true,
         'data-dependent': { 'time_remaining_format_use_custom': true },
      },
      ...
      time_remaining_format_templates: {
         _tagName: 'select',
         label: 'Time pattern templates',
         // 'label:zh': '',
         // 'label:ja': '',
         // 'label:ko': '',
         // 'label:vi': '',
         ...
         // 'title:pl': '',
         // 'title:ua': '',
         'data-dependent': { 'time_remaining_format_use_custom': false },
         required: true,
         options: [
            {
      ...
      time_remaining_format_use_custom: {
         _tagName: 'input',
         label: 'Use custom time pattern',
         type: 'checkbox',
      },
